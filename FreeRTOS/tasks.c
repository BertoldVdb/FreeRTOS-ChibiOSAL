...
void* pxTaskGetUserData(TaskHandle_t xTask)
{
	return prvGetTCBFromHandle(xTask)->pxUserData;
}

void vTaskSetUserData(TaskHandle_t xTask, void* pxUserData)
{
	prvGetTCBFromHandle(xTask)->pxUserData = pxUserData;
}
